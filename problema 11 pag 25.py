n = int(input('Scriti numărul de elemente in vector: '))
a = []
print('Scriti ', n, ' elemente pentru vectorul creat: ')
for i in range(0, n):
...
a1 = a.copy()
a1[0] = min(a)
print('k)  înlocuieşte prima componentă a tabloului cu componenta de valoare minimă din tabloul respectiv: ', a1)
a2 = a.copy()
a2[a2.index(min(a2))] = a2[0]
print('l)  înlocuieşte componenta de valoare minimă din tabloul respectiv cu prima componentă a acestuia: ', a2)
